...
```bash
# 自我反思（回顾最近7天）
node actions/reflect.js --workspace /path/to/workspace

# 回顾最近30天
node actions/reflect.js --workspace /path/to/workspace --days 30
```
